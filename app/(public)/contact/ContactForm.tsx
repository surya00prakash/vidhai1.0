...
import { Image, Link, Card, CardBody, Button, Checkbox, Input, Textarea, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, useDisclosure } from "@heroui/react";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <a
                                                ...
                                                className="text-green-600 hover:text-green-800 transition-colors duration-200 text-lg block"
                                            >
                                                +91 98418 91000
                                            </a>
                                            <a
                    ...
                    <div className="space-y-8">
                        <div className="max-w-lg mx-auto p-6 rounded-2xl shadow-lg bg-white">
                            ...
                            <form id="enquiry-form" action={handleSubmit} className="space-y-4">
                                <Input label="Full Name" name="name" isRequired />
                                <Input label="Phone Number" type="tel" name="phone" isRequired />
                                <Input label="Email Address" type="email" name="email" />
                                <Textarea label="Message" name="message" minRows={4} isRequired />
                                <Checkbox className="my-2" name="consent" value="on">
                            ...
                            <ModalContent>
                                {(onClose) => (
                                    <>
                                        ...
                                        <ModalBody>
                                            <p>
                                                Thank you for reaching out to Agaram Foundation. Our team will get back to you soon.
                                            </p>
                                        </ModalBody>
                                        <ModalFooter>
                        ...
                        {/* Social Media */}
                        <Card className="shadow-lg mx-auto max-w-lg">
