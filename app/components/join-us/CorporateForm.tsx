...
import { LuTarget, LuTrendingUp, LuUsers, LuAward } from 'react-icons/lu';
...
export default function CorporateHeroSection() {
    ...
    const validate = () => {
        const fieldsToValidate: (keyof FormData)[] = [
            "corporateName", "email", "phone", "contactPerson", "address",
            "country", "state", "city", "pincode", "industry", "supportTypes", "agreed"
        ];
    ...
    const handleSubmit = async () => {
        const allFields = new Set<keyof FormData>([
            "corporateName", "email", "phone", "contactPerson", "address",
            "country", "state", "city", "pincode", "industry", "supportTypes", "agreed"
        ]);
                    ...
                    <Button
                        ...
                        onPress={() => {
                            setFormData({
                                corporateName: "", email: "", phone: "", contactPerson: "",
                                address: "", country: "", state: "", city: "", pincode: "",
                                website: "", industry: "", supportTypes: [],
                                referral: "", comments: "", agreed: false
                            });
                            setFormErrors({});
    ...
    return (
        <div className="bg-gradient-to-r from-slate-50 to-blue-50 py-16 lg:py-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <h1 className="text-4xl lg:text-5xl font-normal text-gray-800 leading-tight mb-6">
                            Transform your CSR into
                            <span className="text-[#0891b2] font-medium"> measurable impact</span>
                        </h1>
                        <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                            Partnering with Agaram offers a meaningful way to fulfill your CSR commitments while creating trackable outcomes. From scholarships and hostels to rural fellowships and school infrastructure, we provide clear impact reports, financial transparency, and employee engagement opportunities.
                        </p>

                        <div className="space-y-4 mb-8">
                            <div className="flex items-start space-x-3">
                                <div className="w-5 h-5 bg-[#0891b2] rounded-full mt-1 flex-shrink-0"></div>
                                <p className="text-gray-700">Expand access to quality education for first-generation learners in rural communities</p>
                            </div>
                            <div className="flex items-start space-x-3">
                                <div className="w-5 h-5 bg-[#0891b2] rounded-full mt-1 flex-shrink-0"></div>
                                <p className="text-gray-700">Engage your employees through volunteering, workshops, and mentorship programs</p>
                            </div>
                            <div className="flex items-start space-x-3">
                                <div className="w-5 h-5 bg-[#0891b2] rounded-full mt-1 flex-shrink-0"></div>
                                <p className="text-gray-700">Build a skilled, confident, and future-ready workforce that benefits society and industry</p>
                            </div>
                        </div>

                    </div>

                    {/* Right Content - Impact showcase */}
                    <div className="lg:pl-12">
                        <div className="bg-white rounded-lg shadow-sm p-8 border border-gray-100">
                            <div className="text-center mb-6">
                                <h3 className="text-xl font-medium text-gray-800 mb-2">Partnership Impact</h3>
                                <p className="text-gray-600 text-sm">When corporate strength meets grassroots change</p>
                            </div>

                            <div className="space-y-6">
                                <div className="flex items-center space-x-4">
                                    <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center">
                                        <LuTarget className="w-6 h-6 text-[#0891b2]" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-800">Clear Outcomes</h4>
                                        <p className="text-sm text-gray-600">Detailed impact reports with measurable results</p>
                                    </div>
                                </div>

                                <div className="flex items-center space-x-4">
                                    <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center">
                                        <LuTrendingUp className="w-6 h-6 text-[#0891b2]" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-800">Financial Transparency</h4>
                                        <p className="text-sm text-gray-600">Complete visibility into fund utilization</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <h4 className="font-medium text-gray-800">Employee Engagement</h4>
                                        <p className="text-sm text-gray-600">Meaningful volunteer opportunities for your team</p>
                                    </div>
                                </div>

                                <div className="flex items-center space-x-4">
                                    <div className="w-12 h-12 bg-blue-50 rounded-full flex items-center justify-center">
                                        <LuAward className="w-6 h-6 text-[#0891b2]" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-800">Future-Ready Workforce</h4>
                                        <p className="text-sm text-gray-600">Skilled talent pipeline for industry growth</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                                <p className="text-sm text-gray-700 text-center italic">
                                    "The results are not just numbers; they are transformed futures."
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="p-4 sm:p-6 md:p-8 bg-white rounded-lg shadow-md max-w-4xl mx-auto mb-20">
                <div className="text-center mb-6">
                    <h2 className="text-2xl md:text-3xl font-semibold mb-2">Corporate Donor Inquiry</h2>
                ...
                <Card className="shadow-none border-none bg-white mb-8">
                    <CardBody className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Input label="Corporate Name" value={formData.corporateName} onChange={(e) => handleChange("corporateName", e.target.value)} onBlur={() => handleBlur("corporateName")} isInvalid={touchedFields.has("corporateName") && !!formErrors.corporateName} errorMessage={formErrors.corporateName} isRequired />
                        ...
                        <Input label="Industry" value={formData.industry} onChange={(e) => handleChange("industry", e.target.value)} onBlur={() => handleBlur("industry")} isInvalid={touchedFields.has("industry") && !!formErrors.industry} errorMessage={formErrors.industry} isRequired />
                        <Select
                            label="Type of Support"
                            selectedKeys={formData.supportTypes}
                            onSelectionChange={(keys) =>
                                handleChange("supportTypes", Array.from(keys))
                            }
                            onBlur={() => handleBlur("supportTypes")}
                            selectionMode="multiple"
                            isInvalid={touchedFields.has("supportTypes") && !!formErrors.supportTypes}
                            errorMessage={formErrors.supportTypes}
                            isRequired
                        >
                        ...
                        <Input
                            label="How do you know about Agaram?"
                            value={formData.referral}
                            onChange={(e) => handleChange("referral", e.target.value)}
                            placeholder="e.g., Newspaper, social media, friends, etc."
                        />
                    </CardBody>
                </Card>
                ...
                <Card className="shadow-none border-none bg-white mb-4">
                    <CardBody className="space-y-4">
                        <Textarea
                            label="Any other general comments or inquiries?"
                        ...
                        <Checkbox
                            ...
                            onValueChange={(value) => handleChange("agreed", value)}
                            onBlur={() => handleBlur("agreed")}
                            isInvalid={touchedFields.has("agreed") && !!formErrors.agreed}
                            isRequired
                        >
                            I agree to the Agaram terms and conditions
                        </Checkbox>
